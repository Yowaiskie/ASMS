    ...
    <form action="<?= URLROOT ?>/schedules/store" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="mass_type" required placeholder="e.g. Sunday Early Mass, Wedding" 
                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all">
        </div>
        ...
        <div>
            ...
            <select name="status" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all cursor-pointer">
        ...
        <div class="flex items-center gap-3 pt-4">
            <button type="submit" class="flex-1 bg-primary hover:bg-primary-700 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-primary-200 transition-all">Create Schedule</button>
