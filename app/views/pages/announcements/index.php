            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 relative group hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="flex items-center gap-2">
                        <button type="button" data-loading="Deleting..." onclick="showConfirm('Are you sure you want to delete this announcement?', 'Delete Announcement', () => window.location.href='<?= URLROOT ?>/announcements/delete?id=<?= $announcement->id ?>&page=<?= $pagination['page'] ?? 1 ?>')" class="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors"><svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg></button>
                    </div>
                </div>
